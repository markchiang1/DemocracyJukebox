(function () {
  var h, k = this; function l (a) { return typeof a === 'string' }
  function m (a) { a = a.split('.'); for (var b = k, c = 0; c < a.length; c++) if (b = b[a[c]], b == null) return null; return b }
  function aa () {}
  function p (a) {
  ...
  function q (a) { var b = typeof a; return b == 'object' && a != null || b == 'function' }
  var r = 'closure_uid_' + (1E9 * Math.random() >>> 0), t = 0; function ba (a, b, c) { return a.call.apply(a.bind, arguments) }
  function ca (a, b, c) { if (!a) throw Error(); if (arguments.length > 2) { var d = Array.prototype.slice.call(arguments, 2); return function () { var c = Array.prototype.slice.call(arguments); Array.prototype.unshift.apply(c, d); return a.apply(b, c) } } return function () { return a.apply(b, arguments) } }
  function u (a, b, c) { Function.prototype.bind && Function.prototype.bind.toString().indexOf('native code') != -1 ? u = ba : u = ca; return u.apply(null, arguments) }
  var da = Date.now || function () { return +new Date() }
  function v (a, b) { var c = a.split('.'), d = k; c[0] in d || typeof d.execScript === 'undefined' || d.execScript('var ' + c[0]); for (var e; c.length && (e = c.shift());)c.length || void 0 === b ? d[e] && d[e] !== Object.prototype[e] ? d = d[e] : d = d[e] = {} : d[e] = b }
  function w (a, b) {
    function c () {}
  ...
  ;var x = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0) } : function (a, b) {
      if (l(a)) return l(b) && b.length == 1 ? a.indexOf(b, 0) : -1
  ...
  function ea (a, b) { a: { var c = a.length; for (var d = l(a) ? a.split('') : a, e = 0; e < c; e++) if (e in d && b.call(void 0, d[e], e, a)) { c = e; break a }c = -1 } return c < 0 ? null : l(a) ? a.charAt(c) : a[c] }
  function fa (a) { return Array.prototype.concat.apply([], arguments) }
  function z (a) { var b = a.length; if (b > 0) { for (var c = Array(b), d = 0; d < b; d++)c[d] = a[d]; return c } return [] }
  ;function A (a, b) { this.c = a; this.f = b; this.b = 0; this.a = null }
  A.prototype.get = function () { if (this.b > 0) { this.b--; var a = this.a; this.a = a.next; a.next = null } else a = this.c(); return a }; var ha = /&/g, ia = /</g, ja = />/g, ka = /"/g, la = /'/g, ma = /\x00/g, na = /[\x00&<>"']/; var B; a: { var C = k.navigator; if (C) { var D = C.userAgent; if (D) { B = D; break a } }B = '' };function oa (a) { var b = E, c; for (c in b) if (a.call(void 0, b[c], c, b)) return c }
  ;function pa (a) { k.setTimeout(function () { throw a }, 0) }
  var F
  function qa () {
    var a = k.MessageChannel; typeof a === 'undefined' && typeof window !== 'undefined' && window.postMessage && window.addEventListener && B.indexOf('Presto') == -1 && (a = function () {
      var a = document.createElement('IFRAME'); a.style.display = 'none'; a.src = ''; document.documentElement.appendChild(a); var b = a.contentWindow; a = b.document; a.open(); a.write(''); a.close(); var c = 'callImmediate' + Math.random(), d = b.location.protocol == 'file:' ? '*' : b.location.protocol + '//' + b.location.host; a = u(function (a) {
        if ((d == '*' || a.origin == d) &&
a.data == c) this.port1.onmessage()
      }, this)
      b.addEventListener('message', a, !1); this.port1 = {}; this.port2 = {postMessage: function () { b.postMessage(c, d) }}
    })
    if (typeof a !== 'undefined' && B.indexOf('Trident') == -1 && B.indexOf('MSIE') == -1) {
  ...
  var J; function sa () {
    if (k.Promise && k.Promise.resolve) { var a = k.Promise.resolve(void 0); J = function () { a.then(ua) } } else {
      J = function () {
        var a = ua, c
        !(c = p(k.setImmediate) != 'function') && (c = k.Window && k.Window.prototype) && (c = B.indexOf('Edge') == -1 && k.Window.prototype.setImmediate == k.setImmediate); c ? (F || (F = qa()), F(a)) : k.setImmediate(a)
      }
    }
  }
  var K = !1, ta = new G(); function ua () { for (var a; a = ta.remove();) { try { a.a.call(a.b) } catch (c) { pa(c) } var b = I; b.f(a); b.b < 100 && (b.b++, a.next = b.a, b.a = a) }K = !1 }
  ;function L () { this.c = this.c; this.f = this.f }
  L.prototype.c = !1; L.prototype.dispose = function () { this.c || (this.c = !0, this.w()) }
  L.prototype.w = function () { if (this.f) for (;this.f.length;) this.f.shift()() }; function va (a, b) { var c, d; var e = document; e = b || e; if (e.querySelectorAll && e.querySelector && a) return e.querySelectorAll(a ? '.' + a : ''); if (a && e.getElementsByClassName) { var g = e.getElementsByClassName(a); return g }g = e.getElementsByTagName('*'); if (a) { var f = {}; for (c = d = 0; e = g[c]; c++) { var n = e.className, N; if (N = typeof n.split === 'function')N = x(n.split(/\s+/), a) >= 0; N && (f[d++] = e) }f.length = d; return f } return g }
  ...
  h.C = function (a) { var b = this.a[a]; if (b) { var c = this.b[b]; if (this.h != 0) this.g.push(a), this.a[a + 1] = aa; else { if (c) { var d = x(c, a); d >= 0 && Array.prototype.splice.call(c, d, 1) } delete this.a[a]; delete this.a[a + 1]; delete this.a[a + 2] } } return !!b }
  h.G = function (a, b) { var c = this.b[a]; if (c) { for (var d = Array(arguments.length - 1), e = 1, g = arguments.length; e < g; e++)d[e - 1] = arguments[e]; if (this.m) for (e = 0; e < c.length; e++) { var f = c[e]; za(this.a[f + 1], this.a[f + 2], d) } else { this.h++; try { for (e = 0, g = c.length; e < g; e++)f = c[e], this.a[f + 1].apply(this.a[f + 2], d) } finally { if (this.h--, this.g.length > 0 && this.h == 0) for (;c = this.g.pop();) this.C(c) } } return e != 0 } return !1 }
  ...
  function Ca (a, b, c) { if (p(b) == 'array') for (var d = 0; d < b.length; d++)Ca(a, String(b[d]), c); else b != null && c.push(a + (b === '' ? '' : '=' + encodeURIComponent(String(b)))) }
  function Da (a) { var b = [], c; for (c in a)Ca(c, a[c], b); return b.join('&') }
  var Ea = /#|$/; var P = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {}; v('yt.config_', P); function Fa (a) { var b = arguments; if (b.length > 1)P[b[0]] = b[1]; else { b = b[0]; for (var c in b)P[c] = b[c] } }
  ...
  function Q (a) {
    this.type = ''; this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.clientY = this.clientX = 0; this.changedTouches = this.touches = null; if (a = a || window.event) {
      this.a = a; for (var b in a)b in Ja || (this[b] = a[b]); (b = a.target || a.srcElement) && b.nodeType == 3 && (b = b.parentNode); this.target = b; if (b = a.relatedTarget) try { b = b.nodeName ? b : null } catch (c) { b = null } else {
        this.type == 'mouseover' ? b = a.fromElement
          : this.type == 'mouseout' && (b = a.toElement)
  ...
  function La (a, b, c, d) {
    d = void 0 === d ? {} : d; a.addEventListener && (b != 'mouseenter' || 'onmouseenter' in document ? b != 'mouseleave' || 'onmouseenter' in document ? b == 'mousewheel' && 'MozBoxSizing' in document.documentElement.style && (b = 'MozMousePixelScroll') : b = 'mouseout' : b = 'mouseover'); return oa(function (e) {
      var g = typeof e[4] === 'boolean' && e[4] == !!d, f; if (f = q(e[4]) && q(d))a: { f = e[4]; for (var n in f) if (!(n in d) || f[n] !== d[n]) { f = !1; break a } for (n in d) if (!(n in f)) { f = !1; break a }f = !0 } return !!e.length && e[0] == a && e[1] == b && e[2] == c &&
(g || f)
    })
  }
  function Ma (a) { a && (typeof a === 'string' && (a = [a]), y(a, function (a) { if (a in E) { var b = E[a], d = b[0], e = b[1], g = b[3]; b = b[4]; d.removeEventListener ? Na() || typeof b === 'boolean' ? d.removeEventListener(e, g, b) : d.removeEventListener(e, g, !!b.capture) : d.detachEvent && d.detachEvent('on' + e, g); delete E[a] } })) }
  ...
  function Oa (a, b, c) {
    var d = void 0 === d ? {} : d; if (a && (a.addEventListener || a.attachEvent)) {
      var e = La(a, b, c, d); if (!e) {
        e = ++Ka.count + ''; var g = !(b != 'mouseenter' && b != 'mouseleave' || !a.addEventListener || 'onmouseenter' in document); var f = g ? function (d) { d = new Q(d); if (!wa(d.relatedTarget, function (b) { return b == a })) return d.currentTarget = a, d.type = b, c.call(a, d) } : function (b) {
          b = new Q(b)
          b.currentTarget = a; return c.call(a, b)
        }
        f = Ga(f); a.addEventListener ? (b == 'mouseenter' && g ? b = 'mouseover' : b == 'mouseleave' && g ? b = 'mouseout' : b == 'mousewheel' && 'MozBoxSizing' in document.documentElement.style && (b = 'MozMousePixelScroll'), Na() || typeof d === 'boolean' ? a.addEventListener(b, f, d) : a.addEventListener(b, f, !!d.capture)) : a.attachEvent('on' + b, f); E[e] = [a, b, c, f, d]
      }
    }
  }
  ;function Pa (a) { p(a) == 'function' && (a = Ga(a)); return window.setInterval(a, 250) }
  ...
  function T (a, b) { var c; a.tagName.toLowerCase().substr(0, 3) == 'yt:' ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Ra(b)] : a.getAttribute('data-' + b) : null; return c }
  function Va (a, b) { O.G.apply(O, arguments) }
  ;function Wa (a) { this.b = a || {}; this.f = {}; this.c = this.a = !1; a = document.getElementById('www-widgetapi-script'); if (this.a = !!(document.location.protocol == 'https:' || a && a.src.indexOf('https:') == 0)) { a = [this.b, window.YTConfig || {}, this.f]; for (var b = 0; b < a.length; b++)a[b].host && (a[b].host = a[b].host.replace('http://', 'https://')) } }
  ...
  Wa.prototype.g = function (a) { if (a.origin == V(this, 'host') || a.origin == V(this, 'host').replace(/^http:/, 'https:')) { try { var b = JSON.parse(a.data) } catch (c) { return } this.c = !0; this.a || a.origin.indexOf('https:') != 0 || (this.a = !0); if (a = U[b.id])a.A = !0, a.A && (y(a.s, a.B, a), a.s.length = 0), a.H(b) } }; function W (a, b, c) {
    this.h = this.a = this.b = null; this.g = this[r] || (this[r] = ++t); this.c = 0; this.A = !1; this.s = []; this.f = null; this.l = c; this.m = {}; c = document; if (a = l(a) ? c.getElementById(a) : a) {
      if (c = a.tagName.toLowerCase() == 'iframe', b.host || (b.host = c ? Ba(a.src) : 'https://www.youtube.com'), this.b = new Wa(b), c || (b = Ya(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[r] || (a[r] = ++t), b.id = 'widget' + a), R[this.a.id] = this, window.postMessage) {
  ...
  h.addEventListener = function (a, b) {
    var c = b; typeof b === 'string' && (c = function () { window[b].apply(window, arguments) })
    this.f.subscribe(a, c); ab(this, a); return this
  }
  function $a (a, b) { var c = b.split('.'); if (c.length == 2) { var d = c[1]; a.l == c[0] && ab(a, d) } }
  h.J = function () { this.a.id && (R[this.a.id] = null); var a = this.f; a && typeof a.dispose === 'function' && a.dispose(); if (this.h) { a = this.a; var b = a.parentNode; b && b.replaceChild(this.h, a) } else (a = this.a) && a.parentNode && a.parentNode.removeChild(a); U && (U[this.g] = null); this.b = null; a = this.a; for (var c in E)E[c][0] == a && Ma(c); this.h = this.a = null }
  h.u = function () { return {} }
...
(n.origin = window.location.protocol + '//' + window.location.host); n.widgetid = a.g; window.location.href && y(['debugjs', 'debugcss'], function (a) { var b = window.location.href; var c = b.search(Ea); b: { var d = 0; for (var e = a.length; (d = b.indexOf(a, d)) >= 0 && d < c;) { var f = b.charCodeAt(d - 1); if (f == 38 || f == 63) if (f = b.charCodeAt(d + e), !f || f == 61 || f == 38 || f == 35) break b; d += e + 1 }d = -1 } if (d < 0)b = null; else { e = b.indexOf('&', d); if (e < 0 || e > c)e = c; d += a.length + 1; b = decodeURIComponent(b.substr(d, e - d).replace(/\+/g, ' ')) }b === null || (n[a] = b) })
  ...
  h.B = function (a) { a.id = this.g; a.channel = 'widget'; a = xa(a); var b = this.b; var c = Ba(this.a.src); b = c.indexOf('https:') == 0 ? [c] : b.a ? [c.replace('http:', 'https:')] : b.c ? [c] : [c, c.replace('http:', 'https:')]; if (!this.a.contentWindow) throw Error('The YouTube player is not attached to the DOM.'); for (c = 0; c < b.length; c++) try { this.a.contentWindow.postMessage(a, b[c]) } catch (d) { if (d.name && d.name == 'SyntaxError')Ha(d, 'WARNING'); else throw d } }; function bb (a) { return (a.search('cue') == 0 || a.search('load') == 0) && a != 'loadModule' }
  function cb (a) { return a.search('get') == 0 || a.search('is') == 0 }
  ...
  w(Y, W); function db (a) { if (a.tagName.toLowerCase() != 'iframe') { var b = T(a, 'videoid'); b && (b = {videoId: b, width: T(a, 'width'), height: T(a, 'height')}, new Y(a, b)) } }
  ...
  function fb (a, b) {
    y(b, function (a) {
      this[a] || (a == 'getCurrentTime' ? this[a] = function () { var a = this.j.currentTime; if (this.j.playerState == 1) { var b = (da() / 1E3 - this.j.currentTimeLastUpdated_) * this.j.playbackRate; b > 0 && (a += Math.min(b, 1)) } return a } : bb(a) ? this[a] = function () {
        this.j = {}
        this.i = {}; X(this, a, arguments); return this
      } : cb(a) ? this[a] = function () {
        var b = 0
        a.search('get') == 0 ? b = 3 : a.search('is') == 0 && (b = 2); return this.j[a.charAt(b).toLowerCase() + a.substr(b + 1)]
      } : this[a] = function () {
        X(this, a, arguments)
        return this
      })
  ...
  h.O = function () {
    var a = parseInt(V(this.b, 'width'), 10); var b = parseInt(V(this.b, 'height'), 10); var c = V(this.b, 'host') + this.v(); na.test(c) && (c.indexOf('&') != -1 && (c = c.replace(ha, '&amp;')), c.indexOf('<') != -1 && (c = c.replace(ia, '&lt;')), c.indexOf('>') != -1 && (c = c.replace(ja, '&gt;')), c.indexOf('"') != -1 && (c = c.replace(ka, '&quot;')), c.indexOf("'") != -1 && (c = c.replace(la, '&#39;')), c.indexOf('\x00') != -1 && (c = c.replace(ma, '&#0;'))); a = '<iframe width="' + a + '" height="' + b + '" src="' + c + '" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    return a
  }
  ...
  w(Z, W); function gb (a) { if (a.tagName.toLowerCase() != 'iframe') { var b = T(a, 'videoid'); if (b) { b = {videoId: b, events: {}}; b.width = T(a, 'width'); b.height = T(a, 'height'); b.thumbWidth = T(a, 'thumb-width'); b.thumbHeight = T(a, 'thumb-height'); b.thumbAlign = T(a, 'thumb-align'); var c = T(a, 'onclick'); c && (b.events.onClick = c); new Z(a, b) } } }
  ...
  typeof YTConfig !== 'undefined' && YTConfig.parsetags && YTConfig.parsetags != 'onload' || Ta(); var hb = m('onYTReady'); hb && hb(); var ib = m('onYouTubeIframeAPIReady'); ib && ib(); var jb = m('onYouTubePlayerAPIReady'); jb && jb()
}).call(this)
